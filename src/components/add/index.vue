...
<template>
  <div class="px-52 py-12">
    ...
    <div class="flex flex-col gap-3 mt-3">
      <input v-model="dataToPost.soNumber" @input="_handleSoNumberInput"
      ...
      <input v-model="dataToPost.namaCustomer" class="w-1/2 p-3 border-2 border-black placeholder:p-2 rounded-lg"
        type="text" placeholder="Nama Customer">
      <input v-model="dataToPost.date" class="w-1/2 p-3 border-2 border-black placeholder:p-2 rounded-lg" type="date"
...
const sendData = async () => {
  ...
  if (!isSubmitDisabled.value) {
    ...
    const response = await fetch('http://localhost:8000/api/sales_orders/new', {
      headers: {
